...
export class CityProvider {
  ...
  public getGroupCities() {
    var group = [];
    var indexs = this.getIndexes();
  ...
  public filterCities(newVal) {
    var filterCities = [];
    var pinyin = this.codefans_net_CC2PY(newVal).toUpperCase();
    this.cities.forEach((city) => {
      var targetPy = this.codefans_net_CC2PY(city.name).toUpperCase();
